...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        if (user) {
            try {
                ...
                if (data) {
                    try {
                        ...
                        toast.error('Failed to save login Data', error)
                    }
            ...
            toast.error('Something wrong while google login')
        }
    }
        ...
        <div className='w-full h-screen flex justify-center items-center'>
            ...
            <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
                <div
                    ...
                    style={{
                        backgroundImage: "url('https://png.pngtree.com/thumb_back/fh260/background/20230706/pngtree-3d-render-of-the-interior-of-a-cozy-cafe-restaurant-image_3811953.jpg')",
                    }}
                ></div>
